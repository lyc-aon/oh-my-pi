...
export class SessionManager {
	...
	#recordEntry(entry: SessionEntry): void {
		...
		// Invoke the legacy single callback and every subscriber in isolation: a
		// throw from one listener (e.g. a broken collab socket) must never abort
		// persistence or starve the other observers (e.g. mechanism live mode).
